...
/** Lazily import Agora SDK to avoid issues with non-browser environments. */
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-3">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg border font-medium text-sm transition disabled:opacity-40 disabled:cursor-not-allowed ${cameraEnabled
                ...
                <button
                    onClick={toggleMic}
                    disabled={!localPreview}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg border font-medium text-sm transition disabled:opacity-40 disabled:cursor-not-allowed ${micEnabled
                            ? "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                            : "border-red-400 bg-red-50 text-red-700 hover:bg-red-100"
                        }`}
                >
